...
public class PreludeItems {
    ...
    public static final DeferredItem<Item> COOKSONIA_SPORES = ITEMS.register("cooksonia_spores",
            () -> new ItemNameBlockItem(PreludeBlocks.COOKSONIA_PLANT, new Item.Properties()));



    public static final DeferredItem<Item> SIMPLE_BOTTLE = ITEMS.register("gasbottle",
    ...
    public static final DeferredItem<Item> SKULL_JURAVENATOR = ITEMS.register("skull_juravenator",
            () -> new Item(new Item.Properties().stacksTo(1)));
    public static final DeferredItem<Item> SKULL_ALOSAURUS = ITEMS.register("skull_alosaurus",
            () -> new Item(new Item.Properties().stacksTo(1)));
    public static final DeferredItem<Item> SKULL_GALLIMIMUS = ITEMS.register("skull_gallimimus",
            () -> new Item(new Item.Properties().stacksTo(1)));
    public static final DeferredItem<Item> SKULL_RUGOPS = ITEMS.register("skull_rugops",
            () -> new Item(new Item.Properties().stacksTo(1)));
    public static final DeferredItem<Item> SKULL_PROTEROSUCHUS = ITEMS.register("skull_proterosuchus",
            () -> new Item(new Item.Properties().stacksTo(1)));
    public static final DeferredItem<Item> SKULL_MEGARAPTOR = ITEMS.register("skull_megaraptor",
            () -> new Item(new Item.Properties().stacksTo(1)));
    public static final DeferredItem<Item> SKULL_YUTYRANNUS = ITEMS.register("skull_yutyrannus",
            () -> new Item(new Item.Properties().stacksTo(1)));
    public static final DeferredItem<Item> SKULL_TORVOSAURUS = ITEMS.register("skull_torvosaurus",
            () -> new Item(new Item.Properties().stacksTo(1)));
    public static final DeferredItem<Item> SKULL_CERATOSAURUS = ITEMS.register("skull_ceratosaurus",
            () -> new Item(new Item.Properties().stacksTo(1)));
    public static final DeferredItem<Item> SKULL_AVACERATOPS = ITEMS.register("skull_avaceratops",
            () -> new Item(new Item.Properties().stacksTo(1)));
    public static final DeferredItem<Item> SKULL_ALBERTOSAURUS = ITEMS.register("skull_albertosaurus",
            () -> new Item(new Item.Properties().stacksTo(1)));
    public static final DeferredItem<Item> SKULL_ORODROMEUS = ITEMS.register("skull_orodromeus",
            () -> new Item(new Item.Properties().stacksTo(1)));
    public static final DeferredItem<Item> SKULL_DRYOSAURUS = ITEMS.register("skull_dryosaurus",
            () -> new Item(new Item.Properties().stacksTo(1)));
    public static final DeferredItem<Item> SKULL_SILESAURUS = ITEMS.register("skull_silesaurus",
            () -> new Item(new Item.Properties().stacksTo(1)));
