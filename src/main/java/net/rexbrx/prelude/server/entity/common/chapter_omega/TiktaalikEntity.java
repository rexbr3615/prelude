...
public class TiktaalikEntity extends PathfinderMob implements GeoEntity
{
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);


    public TiktaalikEntity(EntityType<? extends PathfinderMob> entityEntityType, Level level) {
    ...
    protected void tickDeath() {
        ...
        if (this.deathTime == 20) {
            this.remove(TiktaalikEntity.RemovalReason.KILLED);
        }
    }
    ...
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(TiktaalikEntity.class, EntityDataSerializers.STRING);
