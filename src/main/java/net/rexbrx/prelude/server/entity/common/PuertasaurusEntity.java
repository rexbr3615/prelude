...
{
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(PuertasaurusEntity.class, EntityDataSerializers.BOOLEAN);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(PuertasaurusEntity.class, EntityDataSerializers.STRING);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(PuertasaurusEntity.class, EntityDataSerializers.STRING);
    ...
    public PuertasaurusEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(EntityInit.PUERTASAURUS.get(), world);
    }

    public PuertasaurusEntity(EntityType<PuertasaurusEntity> type, Level world) {
        super(type, world);
        xpReward = 5;
        setNoAi(false);
