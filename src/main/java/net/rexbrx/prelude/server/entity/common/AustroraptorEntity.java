...
public class AustroraptorEntity extends PathfinderMob implements GeoEntity
{
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(AustroraptorEntity.class, EntityDataSerializers.BOOLEAN);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(AustroraptorEntity.class, EntityDataSerializers.STRING);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(AustroraptorEntity.class, EntityDataSerializers.STRING);
    ...
    public AustroraptorEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(EntityInit.AUSTRORAPTOR.get(), world);
    }

    public AustroraptorEntity(EntityType<AustroraptorEntity> type, Level world) {
        super(type, world);
        xpReward = 5;
        setNoAi(false);
    ...
    public static AttributeSupplier.Builder createAttributes() {
        ...
        builder = builder.add(Attributes.FOLLOW_RANGE, 32.0f);
    ...
    protected void tickDeath() {
        ...
        if (this.deathTime == 20) {
            this.remove(AustroraptorEntity.RemovalReason.KILLED);
            this.dropExperience();
        }
    }
