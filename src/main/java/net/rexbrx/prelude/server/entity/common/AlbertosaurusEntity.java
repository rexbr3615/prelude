...
public class AlbertosaurusEntity extends PathfinderMob implements GeoEntity
{
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(AlbertosaurusEntity.class, EntityDataSerializers.BOOLEAN);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(AlbertosaurusEntity.class, EntityDataSerializers.STRING);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(AlbertosaurusEntity.class, EntityDataSerializers.STRING);
    ...
    public AlbertosaurusEntity(PlayMessages.SpawnEntity packet, Level world) {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        ...
        builder = builder.add(Attributes.MAX_HEALTH, 74.0f);
        builder = builder.add(Attributes.ATTACK_DAMAGE, 21.0f);
        builder = builder.add(Attributes.ATTACK_SPEED, 2.0f);
        builder = builder.add(Attributes.MOVEMENT_SPEED, 0.167f);
        builder = builder.add(Attributes.ARMOR, 4.0f);
    ...
    protected void tickDeath() {
        ...
        if (this.deathTime == 20) {
            this.remove(AlbertosaurusEntity.RemovalReason.KILLED);
            this.dropExperience();
        }
    }
