...
public class DeinocheirusEntity extends PathfinderMob implements GeoEntity
{
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(DeinocheirusEntity.class, EntityDataSerializers.BOOLEAN);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(DeinocheirusEntity.class, EntityDataSerializers.STRING);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(DeinocheirusEntity.class, EntityDataSerializers.STRING);
    ...
    public DeinocheirusEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(EntityInit.DEINOCHEIRUS.get(), world);
    }

    public DeinocheirusEntity(EntityType<DeinocheirusEntity> type, Level world) {
        super(type, world);
        xpReward = 5;
        setNoAi(false);
    ...
    public static AttributeSupplier.Builder createAttributes() {
        ...
        builder = builder.add(Attributes.MAX_HEALTH, 38.0f);
        builder = builder.add(Attributes.ATTACK_DAMAGE, 9.0f);
    ...
    protected void tickDeath() {
        ...
        if (this.deathTime == 20) {
            this.remove(DeinocheirusEntity.RemovalReason.KILLED);
            this.dropExperience();
        }
    }
