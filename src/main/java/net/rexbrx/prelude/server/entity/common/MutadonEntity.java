...
public class MutadonEntity extends PathfinderMob implements GeoEntity
{
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(MutadonEntity.class, EntityDataSerializers.BOOLEAN);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(MutadonEntity.class, EntityDataSerializers.STRING);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(MutadonEntity.class, EntityDataSerializers.STRING);
    ...
    public MutadonEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(EntityInit.MUTADON.get(), world);
    }

    public MutadonEntity(EntityType<MutadonEntity> type, Level world) {
        super(type, world);
        xpReward = 5;
        setNoAi(false);
    ...
    protected void tickDeath() {
        ...
        if (this.deathTime == 20) {
            this.remove(MutadonEntity.RemovalReason.KILLED);
            this.dropExperience();
        }
    }
