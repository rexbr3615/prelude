...
public class BlueCoelacanthEntity extends PathfinderMob implements GeoEntity
{
    ...
    public BlueCoelacanthEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(EntityInit.BLUE_COELACANTH.get(), world);
    }

    public BlueCoelacanthEntity(EntityType<BlueCoelacanthEntity> type, Level world) {
        super(type, world);
        xpReward = 5;
        setNoAi(false);
