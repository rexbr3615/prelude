...
public class MegaraptorEntity extends PathfinderMob implements GeoEntity
{
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(MegaraptorEntity.class, EntityDataSerializers.BOOLEAN);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(MegaraptorEntity.class, EntityDataSerializers.STRING);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(MegaraptorEntity.class, EntityDataSerializers.STRING);
    ...
    public MegaraptorEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(EntityInit.MEGARAPTOR.get(), world);
    }

    public MegaraptorEntity(EntityType<MegaraptorEntity> type, Level world) {
        super(type, world);
        xpReward = 5;
        setNoAi(false);
    ...
    protected void tickDeath() {
        ...
        if (this.deathTime == 20) {
            this.remove(MegaraptorEntity.RemovalReason.KILLED);
            this.dropExperience();
        }
    }
