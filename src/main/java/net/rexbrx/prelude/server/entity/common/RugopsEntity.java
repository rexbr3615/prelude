...
{
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(RugopsEntity.class, EntityDataSerializers.BOOLEAN);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(RugopsEntity.class, EntityDataSerializers.STRING);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(RugopsEntity.class, EntityDataSerializers.STRING);
    ...
    public RugopsEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(EntityInit.RUGOPS.get(), world);
    }
