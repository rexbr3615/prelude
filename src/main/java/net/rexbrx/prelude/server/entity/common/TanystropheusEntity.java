...
public class TanystropheusEntity extends PathfinderMob implements GeoEntity
{
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(TanystropheusEntity.class, EntityDataSerializers.BOOLEAN);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(TanystropheusEntity.class, EntityDataSerializers.STRING);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(TanystropheusEntity.class, EntityDataSerializers.STRING);
    ...
    public TanystropheusEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(EntityInit.TANYSTROPHEUS.get(), world);
    }

    public TanystropheusEntity(EntityType<TanystropheusEntity> type, Level world) {
        super(type, world);
        xpReward = 5;
        setNoAi(false);
    ...
    protected void tickDeath() {
        ...
        if (this.deathTime == 20) {
            this.remove(TanystropheusEntity.RemovalReason.KILLED);
            this.dropExperience();
        }
    }
