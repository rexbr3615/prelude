...
public class GallimimusEntity extends PathfinderMob implements GeoEntity 
{
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(GallimimusEntity.class, EntityDataSerializers.BOOLEAN);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(GallimimusEntity.class, EntityDataSerializers.STRING);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(GallimimusEntity.class, EntityDataSerializers.STRING);
    ...
    public GallimimusEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(EntityInit.GALLIMIMUS.get(), world);
    }

    public GallimimusEntity(EntityType<GallimimusEntity> type, Level world) {
        super(type, world);
        xpReward = 5;
        setNoAi(false);
    ...
    protected void tickDeath() {
        ...
        if (this.deathTime == 20) {
            this.remove(GallimimusEntity.RemovalReason.KILLED);
            this.dropExperience();
        }
    }
