...
public class AvaceratopsEntity extends PathfinderMob implements GeoEntity
{
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(AvaceratopsEntity.class, EntityDataSerializers.BOOLEAN);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(AvaceratopsEntity.class, EntityDataSerializers.STRING);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(AvaceratopsEntity.class, EntityDataSerializers.STRING);
    ...
    public AvaceratopsEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(EntityInit.AVACERATOPS.get(), world);
    }

    public AvaceratopsEntity(EntityType<AvaceratopsEntity> type, Level world) {
        super(type, world);
        xpReward = 5;
        setNoAi(false);
    ...
    public static AttributeSupplier.Builder createAttributes() {
        ...
        builder = builder.add(Attributes.MAX_HEALTH, 37.0f);
        builder = builder.add(Attributes.ATTACK_DAMAGE, 7.0f);
    ...
    protected void tickDeath() {
        ...
        if (this.deathTime == 20) {
            this.remove(AvaceratopsEntity.RemovalReason.KILLED);
            this.dropExperience();
        }
    }
