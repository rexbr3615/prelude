...
public class BajadasaurusEntity extends PathfinderMob implements GeoEntity
{
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(BajadasaurusEntity.class, EntityDataSerializers.BOOLEAN);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(BajadasaurusEntity.class, EntityDataSerializers.STRING);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(BajadasaurusEntity.class, EntityDataSerializers.STRING);
    ...
    public BajadasaurusEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(EntityInit.BAJADASAURUS.get(), world);
    }

    public BajadasaurusEntity(EntityType<BajadasaurusEntity> type, Level world) {
        super(type, world);
        xpReward = 5;
        setNoAi(false);
    ...
    public static AttributeSupplier.Builder createAttributes() {
        ...
        builder = builder.add(Attributes.MAX_HEALTH, 59.0f);
        builder = builder.add(Attributes.ATTACK_DAMAGE, 24.0f);
    ...
    protected void tickDeath() {
        ...
        if (this.deathTime == 20) {
            this.remove(BajadasaurusEntity.RemovalReason.KILLED);
            this.dropExperience();
        }
    }
