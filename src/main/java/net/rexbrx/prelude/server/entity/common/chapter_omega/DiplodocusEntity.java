...
public class DiplodocusEntity extends PathfinderMob implements GeoEntity
{
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public DiplodocusEntity(EntityType<? extends PathfinderMob> entityEntityType, Level level) {
    ...
    protected void tickDeath() {
        ...
        if (this.deathTime == 20) {
            this.remove(DiplodocusEntity.RemovalReason.KILLED);
        }
    }
    ...
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(DiplodocusEntity.class, EntityDataSerializers.STRING);
