...
public class DryosaurusEntity extends PathfinderMob implements GeoEntity
{
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(DryosaurusEntity.class, EntityDataSerializers.BOOLEAN);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(DryosaurusEntity.class, EntityDataSerializers.STRING);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(DryosaurusEntity.class, EntityDataSerializers.STRING);
    ...
    public DryosaurusEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(EntityInit.DRYOSAURUS.get(), world);
    }

    public DryosaurusEntity(EntityType<DryosaurusEntity> type, Level world) {
        super(type, world);
        xpReward = 5;
        setNoAi(false);
    ...
    protected void tickDeath() {
        ...
        if (this.deathTime == 20) {
            this.remove(DryosaurusEntity.RemovalReason.KILLED);
            this.dropExperience();
        }
    }
