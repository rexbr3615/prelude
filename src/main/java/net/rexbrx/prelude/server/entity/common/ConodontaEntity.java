...
public class ConodontaEntity extends PathfinderMob implements GeoEntity
{
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(ConodontaEntity.class, EntityDataSerializers.BOOLEAN);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(ConodontaEntity.class, EntityDataSerializers.STRING);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(ConodontaEntity.class, EntityDataSerializers.STRING);
    ...
    public ConodontaEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(EntityInit.CONODONTA.get(), world);
    }

    public ConodontaEntity(EntityType<ConodontaEntity> type, Level world) {
        super(type, world);
        xpReward = 5;
        setNoAi(false);
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new PanicGoal(this, 2.8));
    }
    ...
    protected void tickDeath() {
        ...
        if (this.deathTime == 20) {
            this.remove(ConodontaEntity.RemovalReason.KILLED);
            this.dropExperience();
        }
    }
