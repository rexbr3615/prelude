...
{
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(JinfengopteryxEntity.class, EntityDataSerializers.BOOLEAN);
    ...
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(JinfengopteryxEntity.class, EntityDataSerializers.STRING);
    ...
    public JinfengopteryxEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(EntityInit.JINFENGOPTERYX.get(), world);
    }

    public JinfengopteryxEntity(EntityType<JinfengopteryxEntity> type, Level world) {
        super(type, world);
        xpReward = 5;
        setNoAi(false);
