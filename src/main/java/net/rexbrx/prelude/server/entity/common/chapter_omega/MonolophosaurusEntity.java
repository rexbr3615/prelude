...
public class MonolophosaurusEntity extends PathfinderMob implements GeoEntity
{
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public MonolophosaurusEntity(EntityType<? extends PathfinderMob> entityEntityType, Level level) {
    ...
    protected void tickDeath() {
        ...
        if (this.deathTime == 20) {
            this.remove(MonolophosaurusEntity.RemovalReason.KILLED);
        }
    }
    ...
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(MonolophosaurusEntity.class, EntityDataSerializers.STRING);
    ...
    private PlayState procedurePredicate(software.bernie.geckolib.animation.AnimationState event) {
