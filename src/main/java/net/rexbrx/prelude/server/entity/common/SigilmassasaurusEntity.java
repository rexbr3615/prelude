...
public class SigilmassasaurusEntity extends PathfinderMob implements GeoEntity
{
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(SigilmassasaurusEntity.class, EntityDataSerializers.BOOLEAN);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(SigilmassasaurusEntity.class, EntityDataSerializers.STRING);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(SigilmassasaurusEntity.class, EntityDataSerializers.STRING);
    ...
    public SigilmassasaurusEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(EntityInit.SIGILMASSASAURUS.get(), world);
    }

    public SigilmassasaurusEntity(EntityType<SigilmassasaurusEntity> type, Level world) {
        super(type, world);
        xpReward = 5;
        setNoAi(false);
    ...
    public static AttributeSupplier.Builder createAttributes() {
        ...
        builder = builder.add(Attributes.MAX_HEALTH, 55.0f);
        builder = builder.add(Attributes.ATTACK_DAMAGE, 8.5f);
    ...
    protected void tickDeath() {
        ...
        if (this.deathTime == 20) {
            this.remove(SigilmassasaurusEntity.RemovalReason.KILLED);
            this.dropExperience();
        }
    }
