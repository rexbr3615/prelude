...
public class VatModel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("prelude", "vat"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer,
		...
		// Se quiser manter tudo branco (como vanilla)
		int argb = color;

		bone.render(poseStack, vertexConsumer, packedLight, packedOverlay, argb);
		bone2.render(poseStack, vertexConsumer, packedLight, packedOverlay, argb);
		bb_main.render(poseStack, vertexConsumer, packedLight, packedOverlay, argb);
	}
}