...
public class ArgentavisRenderer extends GeoEntityRenderer<ArgentavisEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, ArgentavisEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
        float scale = 0.84f;
