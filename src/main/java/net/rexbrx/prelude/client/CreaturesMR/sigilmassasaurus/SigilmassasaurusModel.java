...
public class SigilmassasaurusModel extends GeoModel<SigilmassasaurusEntity> {
    ...
    public ResourceLocation getModelResource(SigilmassasaurusEntity entity) {
        return new ResourceLocation(prelude.MODID, "geo/sigilmassasaurus.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(SigilmassasaurusEntity entity) {
        return new ResourceLocation(prelude.MODID, "textures/dinosaurs/sigilmassasaurus.png");
    }

    @Override
    public void setCustomAnimations(SigilmassasaurusEntity entity, long uniqueID, AnimationState<SigilmassasaurusEntity> animationState) {
