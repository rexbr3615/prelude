...
public class CeratosaurusRenderer extends GeoEntityRenderer<CeratosaurusEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, CeratosaurusEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
        float scale = 0.921f;
