...
public class OrodromeusRenderer extends GeoEntityRenderer<OrodromeusEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, OrodromeusEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
