...
public class CladoselacheRenderer extends GeoEntityRenderer<CladoselacheEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, CladoselacheEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
