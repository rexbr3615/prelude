...
public class TorvosaurusRenderer extends GeoEntityRenderer<TorvosaurusEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, TorvosaurusEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
