...
public class KentrosaurusRenderer extends GeoEntityRenderer<KentrosaurusEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, KentrosaurusEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
