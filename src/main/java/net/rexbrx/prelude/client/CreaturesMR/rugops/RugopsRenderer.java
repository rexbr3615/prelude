...
public class RugopsRenderer extends GeoEntityRenderer<RugopsEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, RugopsEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
