...
public class MutadonRenderer extends GeoEntityRenderer<MutadonEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, MutadonEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
