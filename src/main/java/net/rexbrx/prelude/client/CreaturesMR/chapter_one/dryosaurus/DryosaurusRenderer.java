...
public class DryosaurusRenderer extends GeoEntityRenderer<DryosaurusEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, DryosaurusEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
