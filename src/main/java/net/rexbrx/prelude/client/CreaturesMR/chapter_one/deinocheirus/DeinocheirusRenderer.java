...
public class DeinocheirusRenderer extends GeoEntityRenderer<DeinocheirusEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, DeinocheirusEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
