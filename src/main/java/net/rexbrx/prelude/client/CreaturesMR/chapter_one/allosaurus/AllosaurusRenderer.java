...
public class AllosaurusRenderer extends GeoEntityRenderer<AllosaurusEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, AllosaurusEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
        float scale = 1.05f;
