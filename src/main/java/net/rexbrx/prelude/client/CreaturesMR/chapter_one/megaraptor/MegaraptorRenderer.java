...
public class MegaraptorRenderer extends GeoEntityRenderer<MegaraptorEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, MegaraptorEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
