...
public class TherizinosaurusRenderer extends GeoEntityRenderer<TherizinosaurusEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, TherizinosaurusEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
