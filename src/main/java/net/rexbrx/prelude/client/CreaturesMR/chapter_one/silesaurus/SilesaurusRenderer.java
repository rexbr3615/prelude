...
public class SilesaurusRenderer extends GeoEntityRenderer<SilesaurusEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, SilesaurusEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
