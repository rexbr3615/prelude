...
public class ProterosuchusRenderer extends GeoEntityRenderer<ProterosuchusEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, ProterosuchusEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
