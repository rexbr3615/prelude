...
public class SiatsRenderer extends GeoEntityRenderer<SiatsEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, SiatsEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
