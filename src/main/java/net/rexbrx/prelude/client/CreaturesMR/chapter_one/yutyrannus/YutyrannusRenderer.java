...
public class YutyrannusRenderer extends GeoEntityRenderer<YutyrannusEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, YutyrannusEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
