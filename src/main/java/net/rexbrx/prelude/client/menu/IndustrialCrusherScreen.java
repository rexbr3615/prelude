...
public class IndustrialCrusherScreen extends AbstractContainerScreen<IndustrialCrusherMenu> {
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(prelude.MODID, "textures/gui/crusher.png");

    public IndustrialCrusherScreen(IndustrialCrusherMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
