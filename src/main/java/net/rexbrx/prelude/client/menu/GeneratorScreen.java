...
import net.rexbrx.prelude.server.energy.EnergyDisplayTooltipArea;
import net.rexbrx.prelude.server.energy.MouseUtil;
...
public class GeneratorScreen extends AbstractContainerScreen<GeneratorMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(prelude.MODID,"textures/gui/generator_gui.png");
